...
export default function Article() {
  ...
  return (
    <>
      ...
      <div className="relative w-full h-[200px] md:h-[300px] mb-6 rounded-lg overflow-hidden">
        <img
      ...
      <div className="px-4 md:px-6">
        <h1 className="text-xl md:text-3xl font-bold leading-tight mb-3">
          'High on the list of items': Ramaswamy threat to claw back Rivian loan sparks criticism of Musk's conflict of
          interest
        </h1>

        <div className="flex flex-wrap items-center gap-2 text-sm text-gray-600 mb-6">
          <span className="font-medium">JEMS.WILL</span>
          <span>·</span>
          <span>6 min ago</span>
        </div>

        <div className="prose prose-sm sm:prose-base prose-gray max-w-none mb-7">
          <p>
